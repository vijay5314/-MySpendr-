  ...
  async function tryBiometric() {
    ...
    try {
      ...
      if (e.name !== "NotAllowedError")
        setBioError("Biometric unavailable, use PIN");
    }
  }
          ...
          {[0, 1, 2, 3].map((i) => (
            <div
              ...
              style={{
                ...
                borderRadius: "50%",
                background:
                  digits.length > i ? "#4f46e5" : dark ? "#1f2937" : "#e5e7eb",
                border: `2px solid ${
                  digits.length > i ? "#4f46e5" : dark ? "#374151" : "#d1d5db"
                }`,
...
export default function App() {
  ...
  /* ── Pot helpers ── */
  function deductPot(source, amount, p) {
    const f = source === "cash" ? "usableCash" : "usableBank";
    return { ...p, [f]: Math.max(0, (Number(p[f]) || 0) - amount) };
  }
  function refundPot(source, amount, p) {
    const f = source === "cash" ? "usableCash" : "usableBank";
    return { ...p, [f]: (Number(p[f]) || 0) + amount };
  }
  ...
  function setUsableField(field, val) {
    ...
    >
      ...
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "24px 16px" }}>
        ...
        {showGoldRateBanner && (
          <div
            style={{
              ...
              border: dark ? "1px solid #92400e" : "1px solid #fde68a",
              borderRadius: 14,
              padding: "12px 14px",
              marginBottom: 12,
            }}
              ...
              <div style={{ flex: 1 }}>
                ...
                <p
                  style={{
                    margin: 0,
                    fontSize: 11,
                    color: dark ? "#d97706" : "#a16207",
                  }}
                >
                  It's the 1st — time to update your gold rate for this month
                </p>
              </div>
              <button
                onClick={() => setGoldBannerDismissed(true)}
                style={{
                  background: "none",
                  border: "none",
                  cursor: "pointer",
            ...
            {showGoldRateForm ? (
              <div style={{ display: "flex", gap: 6 }}>
                <input
                  ...
                  placeholder="₹ per gram (24K)"
                  style={{ ...inputStyle, flex: 1 }}
                  autoFocus
                  onKeyDown={(e) => e.key === "Enter" && saveGoldRate()}
                />
                <button
                ...
                <button
                  onClick={() => setShowGoldRateForm(false)}
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <button
                  onClick={() => setShowGoldRateForm(true)}
                  style={{
                    background: "#d97706",
                    color: "#fff",
                    border: "none",
          ...
          {potVisible && (
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <p
                  style={{ margin: "4px 0 6px", fontSize: 11, color: textMute }}
                >
        ...
        <div style={{ ...cardStyle, marginTop: 8 }}>
          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: 12,
                padding: "12px 14px",
                border: dark ? "1px solid #7f1d1d" : "1px solid #fca5a5",
              }}
            >
              <p
                style={{
          ...
          >
            <span style={{ fontSize: 12, color: textMute, fontWeight: 500 }}>
              Net this month
            </span>
            <span
              style={{
